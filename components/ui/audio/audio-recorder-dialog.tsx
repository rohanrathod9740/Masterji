...
import {Dialog,DialogContent, DialogFooter, DialogHeader, DialogTitle, DialogTrigger} from "@/components/ui/layout/dialog"
import { Button } from "../button";
import AudioRecorder from "./audioRecorder";
import { DownloadIcon } from "@radix-ui/react-icons";

export function AudioRecorderDialog({onLoad}:{onLoad:(blob:Blob)=>void}){
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <DialogFooter className="mt-4">
                    ...
                    onClick={handleLoad}
                    >
                        <DownloadIcon className="size-4 text-white/75" />
                        <span>Load</span>
                    </Button>
                </DialogFooter>
            </DialogContent>
