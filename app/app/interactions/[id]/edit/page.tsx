        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              onClick={() => router.back()}
              disabled={deleting}
              className="flex-1 px-6 py-2 bg-gray-200 text-gray-800 font-medium rounded-lg hover:bg-gray-300 disabled:bg-gray-300 transition"
            >
              Cancel
            </button>
            <button
              ...
              disabled={submitting || deleting}
              className="flex-1 px-6 py-2 bg-red-500 text-white font-medium rounded-lg hover:bg-red-600 disabled:bg-gray-400 transition"
            >
